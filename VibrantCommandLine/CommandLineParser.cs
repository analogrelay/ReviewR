    ...
    public class CommandLineParser
    {
        ...
        public ICommand ExtractOptions(ICommand command, IEnumerator<string> argsEnumerator)
        {
            ...
            while (true)
            {
                ...
                if (!results.Any())
                {
                    throw new CommandLineException(Resources.UnknownOptionError, option);
                }
                ...
                if (results.Skip(1).Any())
                {
                    ...
                    {
                        throw new CommandLineException(String.Format(CultureInfo.CurrentCulture, Resources.AmbiguousOption, optionText,
                ...
                if (value == null)
                {
                    throw new CommandLineException(Resources.MissingOptionValueError, option);
                }
        ...
        private static void AssignValue(PropertyInfo property, ICommand command, string option, object value)
        {
            ...
            {
                throw new CommandLineException(Resources.InvalidOptionValueError, option, value);
            }
        }
        ...
        public ICommand ParseCommandLine(IEnumerable<string> commandLineArgs)
        {
            ...
            if (cmd == null)
            {
                throw new CommandLineException(Resources.UnknownCommandError, cmdName);
            }
