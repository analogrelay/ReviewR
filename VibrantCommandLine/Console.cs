...
namespace VibrantCommandLine
{
    ...
    public class Console : IConsole
    {
        ...
        public void WriteWarning(bool prependWarningText, string value, params object[] args)
        {
            ...
            {
                message = String.Format(CultureInfo.CurrentCulture, Resources.CommandLine_Warning, value);
            }
            else
            {
                message = value;
        ...
        public bool Confirm(string description)
        {
            ...
            try
            {
                ...
                System.Console.Write(String.Format(CultureInfo.CurrentCulture, Resources.ConsoleConfirmMessage, description));
                var result = System.Console.ReadLine();
                return result.StartsWith(Resources.ConsoleConfirmMessageAccept, StringComparison.OrdinalIgnoreCase);
            }
            finally
            {
                System.Console.ForegroundColor = currentColor;
