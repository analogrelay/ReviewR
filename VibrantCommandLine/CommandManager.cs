...
namespace VibrantCommandLine
{
    ...
    public class CommandManager : ICommandManager
    {
        ...
        public ICommand GetCommand(string commandName)
        {
            ...
            {
                throw new ArgumentException(Resources.Argument_Cannot_Be_Null_Or_Empty, commandName);
            }
            ...
            if (!results.Any())
            {
                throw new CommandLineException(Resources.UnknownCommandError, commandName);
            }
            ...
            if (results.Skip(1).Any())
            {
                ...
                if (matchedCommand == null)
                {
                    ...
                    throw new CommandLineException(String.Format(CultureInfo.CurrentCulture, Resources.AmbiguousCommand, commandName,
                ...
                foreach (OptionAttribute attr in propInfo.GetCustomAttributes(typeof(OptionAttribute), true))
                {
                    if (!propInfo.CanWrite && !TypeHelper.IsMultiValuedProperty(propInfo))
                    {
                        ...
                        throw new InvalidOperationException(String.Format(CultureInfo.CurrentCulture,
                            Resources.OptionInvalidWithoutSetter, command.GetType().FullName + "." + propInfo.Name));
                    }
