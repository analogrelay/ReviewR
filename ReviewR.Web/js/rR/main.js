define('rR', ['syrah', 'jquery'], function (sy, $) {
    "use strict";
    var _modules = [];
    var exports = {};
    exports.App = function (rootUrl, environment, pageHost, dialogHost) {
        var self = this;
    ...
    exports.start = function (rootUrl, environment, pageHost, dialogHost) {
