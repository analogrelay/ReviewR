...
var dom = require("./syrah.dom")
var binding = require("./syrah.binding")
var bus = require("./syrah.bus")
var routing = require("./syrah.routing")
var rendering = require("./syrah.rendering")
bus.create('navigate');
bus.create('exec');
bus.create('dismiss');
